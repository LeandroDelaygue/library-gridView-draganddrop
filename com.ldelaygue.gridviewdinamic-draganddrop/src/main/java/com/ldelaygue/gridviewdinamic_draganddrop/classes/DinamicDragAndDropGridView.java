...
public class DinamicDragAndDropGridView extends SpanVariableGridView implements View.OnTouchListener {
	...
	public DinamicDragAndDropGridView(Context context) {
		super(context);

		initialize();
	}

	public DinamicDragAndDropGridView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);

		initialize();
	}

	public DinamicDragAndDropGridView(Context context, AttributeSet attrs) {
		super(context, attrs);
